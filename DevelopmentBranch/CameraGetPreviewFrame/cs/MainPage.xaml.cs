...
namespace CameraGetPreviewFrame
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        System.Net.Http.HttpClient sender;
        ...
        private async Task GetPreviewFrameAsSoftwareBitmapAsync()
        {
            ...
            using (var currentFrame = await _mediaCapture.GetPreviewFrameAsync(videoFrame))
            {
                ...
                if (ShowFrameCheckBox.IsChecked == true)
                {
                    ...
                    // Great unique filename
                    string filename = DateTime.Now.ToString("MMddyyyyHHmmssff") + ".jpg";

                    // Call SaveSoftwareBitmap
                    SaveSoftwareBitmapToFile(previewFrame);
        ...
        async public Task<System.Net.Http.HttpResponseMessage> UploadImage(string url, byte[] ImageData)
        {
            ...
            return await sender.PostAsync(url, requestContent);
        }
