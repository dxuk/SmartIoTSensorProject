...
using Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.Cabin.CommandProcessors;
...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.Cabin.Devices
{
    /// <summary>
    /// Implementation of a specific device type that extends the BaseDevice functionality
    /// </summary>
    public class CabinDevice : DeviceBase
    {

        public CabinDevice(ILogger logger, ITransportFactory transportFactory,
