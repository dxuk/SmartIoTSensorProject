...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.UnitTests.Infrastructure
{
    public class FilterHelperTests
    {
        ...
        {
            var device = DeviceCreatorHelper.BuildCabinDeviceStructure(Guid.NewGuid().ToString(), true, null);
        ...
        {
            var device = DeviceCreatorHelper.BuildCabinDeviceStructure("DeviceID-Test", true, null);
