    ...
    WebApiControllers
{
    public class DeviceApiControllerTests
    {
        ...
        [Fact]
        public async void GenerateSampleCabinDevicesAsyncTest()
        {
            deviceLogic.Setup(mock => mock.GenerateNCabinDevices(5)).Returns(Task.FromResult(true));
            var res = await deviceApiController.GenerateSampleCabinDevicesAsync(5);
            res.AssertOnError();
        ...
        [Fact]
        public async void GenerateSampleCameraDevicesAsyncTest()
        {
            deviceLogic.Setup(mock => mock.GenerateNCameraDevices(5)).Returns(Task.FromResult(true));
            var res = await deviceApiController.GenerateSampleCameraDevicesAsync(5);
            res.AssertOnError();
            var data = res.ExtractContentDataAs<bool>();
            Assert.True(data);
        }
