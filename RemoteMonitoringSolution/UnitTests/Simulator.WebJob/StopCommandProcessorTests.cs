...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.UnitTests.Simulator.WebJob
{
    ...
    {
        private readonly Mock<CabinDevice> _coolerDevice;
        ...
        public StopCommandProcessorTests()
        {
            ...
            _coolerDevice = new Mock<CabinDevice>(_loggerMock.Object, _transportFactory.Object, _telemetryFactoryMock.Object,
