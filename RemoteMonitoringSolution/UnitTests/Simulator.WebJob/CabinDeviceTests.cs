...
{
    public class CabinDeviceTests
    {
        private CabinDevice _coolerDevice;
        private InitialDeviceConfig _initConfig;
        private Mock<ITransport> _transportMock;
        private IFixture _fixture;

        public CabinDeviceTests()
        {
            ...
            var coolerDeviceFactory = new CabinDeviceFactory();
            _coolerDevice = coolerDeviceFactory.CreateDevice(loggerMock.Object, transportFactoryMock.Object,
                telemetryFactoryMock.Object, configurationProviderMock.Object, _initConfig) as CabinDevice;
