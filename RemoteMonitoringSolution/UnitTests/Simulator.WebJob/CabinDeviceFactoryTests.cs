...
{
    public class CabinDeviceFactoryTests
    {
        private CabinDeviceFactory _coolerDeviceFactory;
        private IFixture _fixture;

        public CabinDeviceFactoryTests()
        {
            _coolerDeviceFactory = new CabinDeviceFactory();
