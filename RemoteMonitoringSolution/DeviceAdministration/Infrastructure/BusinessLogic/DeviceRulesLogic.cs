...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.DeviceAdmin.Infrastructure.BusinessLogic
{
    ...
    public class DeviceRulesLogic : IDeviceRulesLogic
    {
        ...
        {
            foreach (var existingDeviceId in existingDeviceIds)
            {
                DeviceRule temperatureRule = await GetNewRuleAsync(existingDeviceId);
                ...
                DeviceRule humidityRule = await GetNewRuleAsync(existingDeviceId);
